...
// Lifted out of app/auth/signup/page.tsx - see SignInForm's header. The
// referral path matters and is unchanged: ?ref=CODE is read here and passed
// as signup metadata so the trigger in 018_referral_integrity.sql records it
// server-side. Those links are shared externally, so /auth/signup has to
// keep working as a real URL with its query string intact.
